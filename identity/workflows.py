...
class SelectSizeAction(workflows.Action):
    ...
    class Meta:
        name = _("Select size")
        slug = "select_size"
        help_text = _("Here you can select the name and size of the Identity & Profile Service")
...
class EnableAccounts(workflows.Workflow):
    slug = "enable_accounts"
    name = _("Enable Identity & Profile Service")
    finalize_button_name = _("Enable")
    success_message = _("Preparing your Identity & Profile Service...")
    failure_message = _("Unable to launch Identity & Profile.")
    success_url = "horizon:project:identity:index"
